...
<head>
    ...
    <link rel="stylesheet" href="<c:url value='/template/home/css/mycss/table.css' />" type="text/css" media="all">
    <link rel="stylesheet" href="<c:url value='/template/home/css/mycss/home_custom.css' />" type="text/css" media="all">
    ...
    <script href="<c:url value="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js"/>" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
    <!-- css -->
    ...
    <script type="text/javascript" src="<c:url value='/template/js/building/building.js' />"></script>
</head>
<style type="text/css">
    option {
