...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
        <a class="navbar-brand" href="/homepage">Royal<span>estate</span></a>
        ...
        <div class="collapse navbar-collapse" style="padding-left: 284px" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a href="/user/list" class="nav-link">Người dùng</a></li>
                <li class="nav-item"><a href="/role/list" class="nav-link">Vai trò</a></li>
                <li class="nav-item"><a href="/building/list" class="nav-link">Tòa nhà</a></li>
                <li class="nav-item"><a href="/customer/list" class="nav-link">Khách hàng</a></li>
